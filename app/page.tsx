        ...
        <main className="min-h-screen bg-transparent relative">
            ...
            <section className="min-h-screen w-full flex flex-col items-center justify-center relative z-10 bg-gradient-to-t from-black to-transparent py-16">
                <div className="text-center p-8 max-w-2xl max-h-screen overflow-y-auto">
                    ...
                    <p className="text-violet-200/60 leading-relaxed font-light">Truth is none of your friends can outshine you. Bhale thode sundar ho, lekin tumhari baat hi kuch alag h. I know tumhe nhi lagta hoga... Try to feel the difference.🌙 You are the moon they are just stars.</p>
                    ...
                    <p className="text-violet-200/60 leading-relaxed font-light">And maybe I deserve a little.... very little attention from you. 🙃🐻‍❄️ Are jyada socho mat text me and say it is amazing🦥🦥 vishwas karo 2 se 3 din khushi me jhoomunga me. </p>
                    <p className="text-violet-200/60 leading-relaxed font-light">Take Care Prachiii, You have a lot to deal with... 🌙 | Background music ke liye maafi lekin yahi match kar rha tha bs..... Or hasti raha karo.... cute lagti ho 😤😤</p>
